      ...
      {youtuber ? (
        <div>
          ...
          <p
            ...
            className="color-grey"
          >
            You have come to the right place, connect your youtube account and get a content creator badge on your profile with many other perks.</p> <br/><h6 className="color-grey">(Google Auth not working? try unblocking our site for third-party cookies from the top-right corner of the address bar on Chrome. If on any other browser, they google it, how to.)</h6>
