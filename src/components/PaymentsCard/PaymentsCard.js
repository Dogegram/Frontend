...
const PayemntsCard = ({currentUser, showAlert, token}) => {
  ...
  useEffect(() => {
    document.title = 'Creator Payout s• Dogegram';
    if (currentUser) {
...
export default connect(mapStateToProps, mapDispatchToProps)(PayemntsCard);